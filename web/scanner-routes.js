...
app.post('/app/api/scan', saasAuth.requireUserAuth, async (req, res) => {
    try {
        ...
        res.json({ ok:true, analysis:{
            ...
            deepEntry: a.deepEntry ? {
                decision:          a.deepEntry.decision,
                action:            a.deepEntry.action,
                optimalEntry:      a.deepEntry.optimalEntry,
                entryLabel:        a.deepEntry.entryLabel,
                confluence:        a.deepEntry.confluence,
                confluenceSources: a.deepEntry.confluenceSources,
                distPct:           a.deepEntry.distPct,
                eta:               a.deepEntry.eta,
                topZones:          a.deepEntry.topZones,
                skipReason:        a.deepEntry.skipReason,
                entryConfScore:    a.deepEntry.entryConfScore,
            } : null,
