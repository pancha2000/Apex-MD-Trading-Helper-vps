...
function getDeepEntryDecision({
    ...
    // rank score = (confluence × 8) - (distance × 1.5)
    // This prefers nearby high-conf zones over distant high-conf zones
    clusters.sort((a, b) =>
        (b.confluence * 8 - b.dist * 1.5) - (a.confluence * 8 - a.dist * 1.5)
    );
    ...
    } else if (best.dist <= 2.5 && confNorm >= 3) {
        // Classic limit zone — near, highly confluent
        decision = 'LIMIT_NEAR';
