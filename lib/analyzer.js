...
async function _run14FactorAnalysisImpl(coin, timeframe = '15m') {
    ...
    const RAW_MAX_POSSIBLE = 120; // measured empirically from all additive branches
    ...
    if      (gradeRaw >= 75 && mtfAlignCount >= 3 && confScore >= 10) {
        signalGrade = 'A+'; signalGradeEmoji = '🏆'; signalGradeLabel = 'ELITE SETUP';
    } else if (gradeRaw >= 60 && mtfAlignCount >= 2) {
